...
namespace FunWithGenericCollections
{
    ...
    public class Person
    {
        ...
        /// <summary>
        /// Display in a formatted string all of the Person properties
        /// </summary>
        /// <returns>String consisting of Name and Age</returns>
    ...
    /// Compare Ages
    /// </summary>
    class ComparePersonByAge : IComparer<Person>
    {
    ...
    class FunWithGenericCollectionsProgram
    {
        ...
        private static void UseGenericList()
        {
            ...
            people.Sort(new ComparePersonByAge()); // sort list using Compare function

            // Print out # of items in List.
            Console.WriteLine("Items in sorted by age generic list: {0}", people.Count);
            ...
            // Insert a new person.
            Console.WriteLine("\n->Inserting new person at position 2");
            people.Insert(2, new Person { FirstName = "Maggie", LastName = "Simpson", Age = 2 });
            Console.WriteLine("Items in list: {0}", people.Count);

            // Copy data into a new array, just to show how List can be converted/copied to an array
            Person[] arrayOfPeople = people.ToArray();

            // could have used foreach here, just shows use of index and for loop with array
        ...
        static void UseGenericQueue()
        {
            ...
            Console.WriteLine("{0} is first in line in queue!", peopleQ.Peek().FirstName);
        ...
        static void UseGenericStack()
        {
            ...
            Console.WriteLine("First person in stack is: {0}", stackOfPeople.Peek());
            Console.WriteLine("Popped off {0}", stackOfPeople.Pop());

            Console.WriteLine("\nFirst person in stack is: {0}", stackOfPeople.Peek());
            Console.WriteLine("Popped off {0}", stackOfPeople.Pop());

            Console.WriteLine("\nFirst person in stack item is: {0}", stackOfPeople.Peek());
            Console.WriteLine("Popped off {0}", stackOfPeople.Pop());

            try
            {
                Console.WriteLine("\nnFirst person in stack is: {0}", stackOfPeople.Peek());
                Console.WriteLine("Popped off {0}", stackOfPeople.Pop());
            }
        ...
        private static void UseSortedSet()
        {
            ...
            SortedSet<Person> setOfPeople = new SortedSet<Person>(new ComparePersonByAge())
            {
                new Person {FirstName = "Homer", LastName = "Simpson", Age = 47},
                new Person {FirstName = "Marge", LastName = "Simpson", Age = 45},
                new Person {FirstName = "Lisa", LastName = "Simpson", Age = 9},
            ...
            Console.WriteLine("Showing SortedSet");
            ...
            Console.WriteLine();
            Console.WriteLine("Showing SortedSet after adding two more persons");
        ...
        private static void UseDictionary()
        {
            ...
            Console.WriteLine("Finding persons in a Dictionary");

...
namespace FunWithArrays
{
    ...
    class FunWithArraysProgram
    {
        ...
        static void ArrayInitialization()
        {
            ...
            string[] stringArray = new string[] { "one", "two", "three", "ten", "twenty"};
        ...
        static void SystemArrayFunctionality()
        {
            ...
            string[] rappers = { "Drake", "JayZ", "Dr. Dre", "J. Cole", "Eminem" };
            ...
            Console.WriteLine(" -> Cleared out 2nd and 3rd...");

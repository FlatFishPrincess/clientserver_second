...
ALTER TABLE [dbo].[Orders]
    ADD CONSTRAINT [FK_Orders_Inventory] FOREIGN KEY ([CarId]) REFERENCES [dbo].[Inventory] ([CarId]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[Orders]
    ADD CONSTRAINT [FK_Orders_Customers] FOREIGN KEY ([CustId]) REFERENCES [dbo].[Customers] ([CustId]) ON DELETE CASCADE;

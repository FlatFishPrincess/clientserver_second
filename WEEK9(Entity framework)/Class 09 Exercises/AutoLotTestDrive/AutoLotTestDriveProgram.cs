...
{
    /// <summary>
    /// This uses the AutoLotDAL database. AutoLotDAL creates the db 
    /// using CodeFirst from blank, and update-database in nuget
    /// 
    /// This depends on AutoLotDAL having created the DB before this runs
    /// </summary>
	class AutoLotTestDriveProgram
	{
		static void Main(string[] args)
		{
            // here is another way to initialize a database

            Database.SetInitializer(new MyDataInitializer());
            new AutoLotEntities().Database.Initialize(true);
			WriteLine("***** Fun with ADO.NET EF Code First *****\n");
            //var car1 = new Inventory() { Make = "Yugo", Color = "Brown", Name = "Brownie" };
            //var car2 = new Inventory() { Make = "SmartCar", Color = "Brown", Name = "Shorty" };
            //AddNewRecord(car1);
            //AddNewRecord(car2);
